...
export const auth = {
  ...
  login: {
    ...
    inactive: 'Учётная запись неактивна. Обратитесь к руководителю.',
    locked: 'Слишком много неудачных попыток. Попробуйте позже.',
    // Брендовая панель справа (двухпанельный логин, ≥ lg)
    panelTitle: 'Дела, клиенты и финансы — в одной системе',
    panelFeature1: 'Воронка дел и контроль этапов',
    panelFeature2: 'Заседания, сроки и календарь команды',
    panelFeature3: 'Платежи, касса и зарплата от оплат',
  },
