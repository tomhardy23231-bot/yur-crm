...
export const users: UsersMessages = {
  ...
  credentials: {
    ...
    setOwnPlaceholder: 'Мінімум 8 символів',
    ...
    inviteHint:
      'Співробітник отримає лист Supabase із посиланням, щоб увійти та задати свій пароль.',
  ...
  errors: {
    ...
    passwordTooShort: 'Пароль — мінімум 8 символів.',
    ...
    inviteFailed: 'Не вдалося надіслати лист. Перевірте налаштування пошти Supabase.',
