...
export const tasks: TasksMessages = {
  ...
  // Рестайл 2026-07-08: компактні рядки з «через N днів» замість підсекцій.
  upcoming: {
    ...
    dueToday: 'сьогодні',
    inDays: { one: 'через {n} день', few: 'через {n} дні', many: 'через {n} днів' },
    overdueDays: {
      one: 'прострочено {n} день',
      few: 'прострочено {n} дні',
      many: 'прострочено {n} днів',
    },
    moreOverdue: 'і ще {n} прострочених →',
  },
