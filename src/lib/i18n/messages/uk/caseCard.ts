...
export const caseCard: CaseCardMessages = {
  ...
  detail: {
    ...
    roleExpert: 'Експерт',
    // Суміщення ролей (0007): юрист і експерт — одна людина, нарахування одне.
    roleDual: 'Юрист і експерт',
  ...
  form: {
    ...
    lawyerRate: '% юриста',
    expertRate: '% експерта',
    // Суміщення ролей (0007): юрист = експерт → один відсоток замість двох.
    dualRate: '% при суміщенні ролей',
    dualRateHint:
      'Юрист і експерт — одна людина: зарплата нараховується один раз. Порожньо → більша зі ставок ролей.',
  ...
  // ── Модалка «ставка при суміщенні ролей» (0007): юрист = експерт справи ──
  dualRate: {
    title: 'Суміщення ролей у справі',
    subtitle: '{name} — і юрист, і експерт цієї справи',
    body: 'Зарплата за такою справою нараховується один раз. Оберіть ставку або введіть свій відсоток. Поки ставку не призначено, застосовується більша зі ставок ролей.',
    presetLawyer: 'Ставка юриста — {percent}%',
    presetExpert: 'Ставка експерта — {percent}%',
    inputLabel: 'Відсоток, %',
    save: 'Зберегти ставку',
    later: 'Пізніше',
  },
};
