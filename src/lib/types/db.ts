...
export type CashEntry = {
  ...
  created_by: string;
  created_at: string;
  // true — операция считается в оборотах и сальдо, хотя датирована раньше
  // opening_date счёта (0019, «внести в оборот»). Обычно такие операции
  // отсекаются: их влияние уже сидит в начальном остатке.
