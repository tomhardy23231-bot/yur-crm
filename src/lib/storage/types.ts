...
//
// ЕДИНСТВЕННАЯ абстракция над хранилищем файлов по делам. Замена Supabase
// Storage. Реализации (S3-совместимая для R2/MinIO, локальная файловая для
...
export type SignedUrlOptions = {
   ...
   */
  download?: string;
  /** TTL ссылки в секундах. По умолчанию 600 (10 мин) — как было в Supabase. */
  expiresIn?: number;
};
...
export interface StorageProvider {
   ...
   * (браузер идёт туда, минуя наш сервер, как раньше с Supabase). Для локального
