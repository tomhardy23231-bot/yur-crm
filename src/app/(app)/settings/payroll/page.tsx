    ...
    <main className="flex flex-col gap-5 px-3 py-2 sm:px-4 max-w-4xl">
      <div className="flex flex-col gap-1.5">
        ...
        <p className="mt-1 text-[13px] text-text-muted">
          Процент от оплаченной суммы по делу, по категории — раздельно для
          юриста и Эксперта (каждый получает свой процент). Это значения по
          умолчанию; на конкретном деле их можно переопределить.
        </p>
      </div>
