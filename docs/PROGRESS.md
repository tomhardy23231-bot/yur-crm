...
- Мобильную нижнюю навигацию и шторку «Ещё» глазами не проверяли (токены
  подтянулись, но стоит взглянуть на устройстве).
- `/settings/*`, `/profile`, модалки и формы наследуют примитивы — беглый
  визуальный проход сделан не по всем подстраницам.
...
- (+ коммит редизайна v5 этой сессии)
