...
`--bg #F4F5F7`, затем по просьбе владельца притемнён ещё раз → итог:
`--bg #ECEEF1`, `--surface-muted #F4F5F8`, `--surface-sunken #E9EBEF`,
`--border #DFE3E9`, `--border-strong #CBD2DA` (+ themeColor). Тёплая молочная
