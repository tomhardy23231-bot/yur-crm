...
>
> **📊 ОТЧЁТЫ КАССЫ (2026-08-03, миграция 0017 — ЛОКАЛЬНО, на прод НЕ выкачено).**
...
> владельца).
>
> **Хвосты:** прод-миграцию 0017 накатить ДО push (гоча типов дел 24.07); в
> данных есть платёж с датой `0004-04-07` (опечатка года) — чинить вручную.
